...
def sort_cards_by_id(a:list[gachalib.types.CardsInventory] | list[gachalib.types.Card]) -> list[gachalib.types.CardsInventory] | list[gachalib.types.Card] | list[gachalib.types.CardsInventory | gachalib.types.Card]:
    return sorted(a, key=lambda b: b.card_id)

def sort_cards_by_rarity(a:list[gachalib.types.CardsInventory] | list[gachalib.types.Card]) -> list[gachalib.types.CardsInventory] | list[gachalib.types.Card] | list[gachalib.types.CardsInventory | gachalib.types.Card]:
